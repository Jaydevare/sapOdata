...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "demo/saleslist/saleslist/test/integration/FirstJourney",
    "demo/saleslist/saleslist/test/integration/SalesOrdersListJourney",
    "demo/saleslist/saleslist/test/integration/SalesOrdersObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
