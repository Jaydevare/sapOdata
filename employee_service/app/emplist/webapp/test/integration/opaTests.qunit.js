...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "demo/emplist/emplist/test/integration/FirstJourney",
    "demo/emplist/emplist/test/integration/EmployeeDetailsListJourney",
    "demo/emplist/emplist/test/integration/EmployeeDetailsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
